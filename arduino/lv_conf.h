 ...
 *
 * Wiring (PlatformIO/Arduino variant): included by LVGL through
 * -DLV_CONF_INCLUDE_SIMPLE + include/ search path; this file sits at the
 * project root and is picked up via simple "lv_conf.h" include.
 */
