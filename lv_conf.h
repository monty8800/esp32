 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_CLIB   /**< Simulator: use libc malloc so large temporary draw-layer buffers (shadows, transforms @32bpp) can never exhaust a fixed LV_MEM pool. A failure there hangs LVGL's render loop. */
